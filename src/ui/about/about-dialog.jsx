    ...
    return (
        ...
        >
            <div class={'font-mono text-muted-foreground pt-6 pb-3 text-center'}>
                {React.createElement(icons.Eclipse, { size: 48, className: 'mx-auto mb-2' })}
                ...
                <div className={`grid grid-cols-2 gap-8 pt-2 pb-6`}>
                    <a href="https://liberapay.com/Steno" onClick={handleLinkClick} target="_blank" rel="noopener noreferrer">
                        <img alt="Liberapay"
                             className={"ml-auto"}
                    ...
                    <a onClick={handleLinkClick} href="https://ko-fi.com/Q5Q61VIM68" target="_blank" rel="noopener noreferrer">
                        <img alt="Ko-fi"
