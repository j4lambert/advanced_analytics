    ...
    return (
        <>
            ...
            <div
                ...
                role="dialog"
                data-state={state}
                className="aa-dialog-dialog fixed left-[50%] top-[50%] z-50 grid translate-x-[-50%] translate-y-[-50%] border backdrop-blur-sm bg-background/90 duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg select-none max-w-[95vw] w-full h-[95vh] p-0 overflow-hidden"
                tabIndex="-1"
                style={{ pointerEvents: 'auto' }}
            >
                {/* Header */}
