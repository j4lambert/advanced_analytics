    ...
    return (
        <>
            ...
            {visible && pos && (
                <Portal>
                    <div
                        className="aa-tooltip fixed z-[10000] px-3 py-1.5 text-sm rounded-md bg-popover text-popover-foreground border border-border shadow-md pointer-events-none leading-snug"
