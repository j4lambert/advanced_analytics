...
export function ButtonsGroup({
    groupClasses = 'bg-muted border inline-flex items-center justify-center mx-auto p-1 rounded-md text-muted-foreground',
    value = null,
    onChange = () => {},
    children
}) {
...
export function ButtonsGroupItem({
    ...
    return React.createElement('button', {
        ...
        className: 'aa-btn-group-btn inline-flex items-center justify-center whitespace-nowrap rounded-sm px-2 py-1 text-xs font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm',
        tabIndex: '-1',
        onClick: handleClick
    }, text);
}
